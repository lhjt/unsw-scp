  ...
  return (
    <>
      ...
      <div css={{ margin: '1rem' }}>
        ...
        <EuiText>
          <p>
            The challenges that are visible are available for you to attempt to complete. Upon
            successfully completing a challenge, you will be supplied with a flag that you should
            submit to the relevant form on this page.
          </p>
        </EuiText>
        <EuiSpacer />
        <EuiCallOut size="m" title="Dynamic Flags" iconType="pin">
          <p>
            Some flags are dynamic. This means that they are independently generated for your
            account, and will not work for other people.
          </p>
        </EuiCallOut>
        <EuiSpacer />
